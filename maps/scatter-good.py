...
if __name__ == '__main__':
    ...
    xfiles = [
        ...
        '/home/liam/Downloads/scratch/C900e-CA/C900e_on_C90-TROP.nc',
    ]
    ...
    for i, (xfile, yfile, name, gridfile) in enumerate(zip(xfiles, yfiles, names, grid_files)):
        ...
        x = x[~np.broadcast_to(mask, x.shape)].flatten()/1e15
        y = xr.open_dataset(yfile)[yvar].squeeze().values #[~mask].flatten()/1e15
        y = y[~np.broadcast_to(mask, y.shape)].flatten()/1e15
