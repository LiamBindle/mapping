...
if __name__ == '__main__':
    ...
    xfiles = [
        '/home/liam/Downloads/foobar/C180-global/TROPOMI_NO2_July2018.nc',
        '/home/liam/Downloads/foobar/C900e-CA/TROPOMI_NO2_July2018.nc',
    ]

    yfiles = [
        '/home/liam/Downloads/foobar/C180-global/GCHP_NO2_July2018.nc',
        '/home/liam/Downloads/foobar/C900e-CA/GCHP_NO2_July2018.nc',
    ]
    ...
    # regions = [
    #     maps.central_valley('/home/liam/Downloads'),
    #     maps.get_california_air_basins('/home/liam/Downloads').to_crs('epsg:2163').to_crs('epsg:4326').loc['San Francisco Bay'].geometry
    # ]
    # region = maps.central_valley('/home/liam/Downloads')
    region = maps.get_california_air_basins('/home/liam/Downloads').to_crs('epsg:2163').to_crs('epsg:4326').loc['San Francisco Bay'].geometry
    ...
    for i, (xfile, yfile, name) in enumerate(zip(xfiles, yfiles, names)):
    ...
    plt.savefig('/home/liam/gmd-sg-manuscript-2020/figures/sf-scatter.png',  dpi=300, bbox_inches='tight')
